...
| [authentication-boundaries](skills/authentication-boundaries/SKILL.md)   | Separate web BFF/native OIDC profiles and domain authority      |
...
| [container-runtime](skills/container-runtime/SKILL.md)                   | Application containers and controlled runtime proof             |
| [nextjs-web](skills/nextjs-web/SKILL.md)                                 | Next.js rendering with a separate business backend              |
...
| [python-development](skills/python-development/SKILL.md)                 | General Python with conditional ingestion guidance              |
...
[Scenario prompts](evaluations/scenarios.md) cover representative architecture, runtime and delivery decisions. Give an evaluator the request, selected skills and minimum raw context without the expected answer. Use a disposable directory, inspect actual outputs, and record missing build/runtime proof. These exercises complement structural validation; they do not certify an application's behavior or replace its tests.
